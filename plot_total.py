...
def plot_execution_times(times_cpu,
    ...
    data = pd.concat([cpu, gpu_omp,cuda_png , omp, python]).reset_index(drop=True)
...
if __name__ == "__main__":
    ...
    plot_execution_times(times_cpu, times_gpu, python_impl, omp_cuda_png, cuda_png, "total_time_comparison.png")
